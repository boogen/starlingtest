...
:: Android packaging
set AND_CERT_NAME="IsometricStarling"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\IsometricStarling.p12
...
set IOS_PROVISION=cert\IsometricStarling.mobileprovision
...
set APP_ID=air.IsometricStarling

:: Output packages
set DIST_PATH=dist
set DIST_NAME=IsometricStarling
